...
## Environments
- Preview: https://main--kratig-nec-poc--aemysites.aem.page/
- Live: https://main--kratig-nec-poc--aemysites.aem.live/
- Block Library: https://main--kratig-nec-poc--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `kratig-nec-poc` directory in your favorite IDE and start coding :)
